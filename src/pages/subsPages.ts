...
`, '', true, { description: 'এডুসব প্রিমিয়াম মেম্বারশিপ — প্রশ্নব্যাংক, সাজেশন, মডেল টেস্ট ও AI সহায়তা আনলক করুন। মাসিক ও বার্ষিক প্ল্যান, যেকোনো সময় বাতিলযোগ্য।', path: '/subscription' })
}
...
`, '', true, { description: 'প্রশ্নপত্র, মডেল টেস্ট ও সাজেশন ব্যাংক — বোর্ড ও বিশ্ববিদ্যালয়ের আগের বছরের প্রশ্ন PDF-সহ। শ্রেণি ও বিষয়ভিত্তিক ফিল্টার।', path: '/qpapers' })
}
