...
export async function initDatabase(): Promise<D1Database> {
  ...
  try {
    const templatesList = [
      ...
      { slug: 'modern-amber', name_bn: 'Team Teal Pro', price: 0, sort_order: 4, config: { primary: '#0f766e', accent: '#14b8a6', font: 'Hind Siliguri', layout: 'sidebar-left', headerStyle: 'band', contactPos: 'sidebar', sectionOrder: ['objective','education','experience','projects','skills','languages','references'], watermark: false, badge: 'Teal Modern', skillStyle: 'bars' } },
