...
const STR = {
  bn: {
    ...
    heroSub: "বোর্ড পরীক্ষার দ্রুত ফলাফল, কলেজ ও বিশ্ববিদ্যালয়ের ভর্তি তথ্য, ১-অন-১ শিক্ষক সহায়তা, ১০,০০০+ প্রশ্নব্যাংক ও প্রফেশনাল সিভি মেকার—সব এক সমন্বিত সিস্টেমে।",
